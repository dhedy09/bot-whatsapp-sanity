...
            }
            ...
            if (trigger) {
                ...
                try {
                    ...
                    // Gunakan prefix agar tidak bentrok dengan schema pegawai
...
if (userMessageLower.startsWith('ingatkan')) {
    ...
    // --- PERBAIKAN: Jika format salah, langsung return ---
    if (!match) {
        message.reply(
